...
async def get_stats(event, key="home"):
    ...
    btns = ButtonMaker()
    btns.ibutton('Back', f'thiruml {user_id} thiruml home')
    if key == "home":
        btns = ButtonMaker()
        btns.ibutton('Bot Stats', f'thiruml {user_id} stats stbot')
        btns.ibutton('OS Stats', f'thiruml {user_id} stats stsys')
        btns.ibutton('Repo Stats', f'thiruml {user_id} stats strepo')
        btns.ibutton('Bot Limits', f'thiruml {user_id} stats botlimits')
        ...
        official_v = (await cmd_exec("curl -o latestversion.py https://github.com/Tamilupdates/KPSML-X/-/raw/hk_thiruml/bot/version.py -s && python3 latestversion.py && rm latestversion.py", True))[0]
    ...
    btns.ibutton('Close', f'thiruml {user_id} close')
